...
const Contact = () => {
  ...
  // Your Web3Forms Submit Logic
  const onSubmit = async (event) => {
    event.preventDefault();
    const formData = new FormData(event.target);

    // Using your specific access key
  ...
  return (
    <section id="contact" className="max-w-7xl mx-auto px-6 py-32 bg-black">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        >
          <form 
            onSubmit={onSubmit}
            className="bg-zinc-900/40 border border-white/10 p-8 md:p-12 rounded-[2.5rem] backdrop-blur-md"
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-white placeholder:text-zinc-700 focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all"
                />
              </div>
              {/* Email Field */}
              <div className="space-y-2">
            ...
            <div className="space-y-2 mb-8">
              ...
              <textarea 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl p-4 text-white placeholder:text-zinc-700 focus:outline-none focus:ring-2 focus:ring-sky-500/20 focus:border-sky-500 transition-all resize-none"
              />
            </div>
