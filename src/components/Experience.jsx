...
export default function Experience() {
  return (
    <section id="experience" className="max-w-7xl mx-auto px-6 py-32 bg-black">
      
      {/* Header */}
      <div className="mb-24">
        <h2 className="text-sm font-bold tracking-[0.4em] text-sky-500 uppercase mb-4">
          Professional Timeline
        </h2>
        <h3 className="text-6xl md:text-7xl font-black text-white tracking-tighter uppercase italic">
          Experience<span className="text-zinc-600">.</span>
        </h3>
      </div>

      <div className="relative border-l border-zinc-900 ml-4 md:ml-12 space-y-20">
        {experiences.map((exp, i) => (
          ...
          >
            ...
            <div className={`absolute -left-[9px] top-2 h-4 w-4 rounded-full bg-zinc-950 border-2 transition-all duration-500 
              ${exp.isCurrent 
                ? "border-sky-500 shadow-[0_0_15px_rgba(56,189,248,0.8)]" 
                : "border-zinc-800 group-hover:border-sky-500 group-hover:shadow-[0_0_15px_rgba(56,189,248,0.5)]"
              }`} 
            />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              <div className="lg:col-span-4">
                ...
                <h4 className="text-3xl font-black text-white uppercase tracking-tighter mb-1">
                  {exp.company}
                </h4>
              ...
              {/* Description Card */}
              <div className={`lg:col-span-8 p-8 rounded-3xl backdrop-blur-sm transition-all duration-500 border 
                ${exp.isCurrent 
